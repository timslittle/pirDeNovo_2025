...
transcriptCvrg.df %>% filter(sample_name == '21659_8_16', !is.na(cdhit_thresh), assembler_name == 'multi')
# 
...
levels(number_transcripts.df$assembler_name) <- ordering(levels(number_transcripts.df$assembler_name),
                                                         "evigene")
