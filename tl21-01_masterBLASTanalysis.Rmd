...
params:
  ...
  blast_output_file: "/camp/lab/langhornej/working/HPC/littlet/tl21-01_testingTrinityChab24h/blast_pirDatabase/rnaspades/21659_8-4/21659_8-4_cdhit0.90_blastn.outfmt6"
  new_table: FALSE
---
...
abline(a = round(nrow(pir.info)/4), b = 0)
abline(a = round(nrow(pir.info)/2), b = 0)
abline(a = round(3*nrow(pir.info)/4), b = 0)
...
# if(any_blast){
  ...
  ancestral_over95 <- ifelse(
    ...
    0)
  ancestral_over75 <- ifelse(
    any(grepl(transcripts_covered_by_denovo_75$sseqid,
              pattern = 'PCHAS_0101200')),
    paste(transcripts_covered_by_denovo_75$sseqid[
