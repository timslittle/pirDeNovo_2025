       ...
       function(expt.id){
         ...
         lapply(unique(expt.df$assembly_id), 
                function(assm.id){
                  ...
                  tpm_pir_max_filter <- round(max(assm.df$TPM[!is.na(assm.df$E.value_fullseq)])/10)
                  ...
                  draw( Heatmap(tpm.mat, 
                                ...
                                col = circlize::colorRamp2(round(c(0, 
                                                                   tpm_pir_max_filter*5,
                                                                   tpm_pir_max_filter*10,
                                                                   tpm_pir_max_filter*20,
                                                                   # max(tpm.mat)/2,
                                                                   ifelse(max(tpm.mat) < 5*tpm_pir_max_filter,
                                                                          tpm_pir_max_filter*30,
                                                                          max(tpm.mat)))),
                                                           c('white',
                                                             viridis::viridis(3), 
                                                             'yellow'))) 
