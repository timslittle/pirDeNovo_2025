...
quant.df <- lapply(experiment.vec,
       function(experiments){
         quant_files <- list.files(path = paste0("../../nextflow/vvx_",
                                                 experiments,
                                                 "_results"),
                                   recursive = TRUE,
                                   pattern = 'quant.sf',
...
quant.df %>% .$source %>% unique

quant_filtered.df <- filter(quant.df, 
       TPM >= 1, 
       NumReads >= 1)

# How many genes are removed for each file source
group_by(quant.df, file_source) %>% 
...
# quant_files <- list.files(path = "../../nextflow/",
#                           recursive = TRUE,
#                           pattern = 'quant.sf',
#                           full.names = TRUE)
# 
