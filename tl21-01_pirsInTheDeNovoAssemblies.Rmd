...
This script is looking at the BLAST results of the Trinity de novo assembled transcriptomes I did with all reads, and the one with the pir database filtered reads, against the pir transcripts of P chabaudi chabaudi AS from PlasmoDB v53. 
